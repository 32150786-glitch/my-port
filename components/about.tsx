...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"graduation","title":"단국대학교 죽전캠퍼스","period":"2020 - 2026","description":"도시계획부동산학부 졸업"},{"icon":"trophy","title":"OPIC intermediate high","period":"2024","description":"비즈니스 분석·자료 리포팅 가능한 영어 능력"},{"icon":"lightbulb","title":"PF & 금융규제 데이터 분석 프로젝트","period":"2024","description":"설명을 입력하세요"},{"icon":"rocket","title":"투자자산운용사 ","period":"2026.03  취득예정","description":"금융상품·리스크·자산배분 이해 기반 분석"}],
